...
const MaterialsPage = ({initialEditionFilter=null}:{initialEditionFilter:string|null}) => {
  const [editionFilter, setEditionFilter] = useState<string | null>(initialEditionFilter);
