...
const MaterialsPage = () => {
  const [editionFilter, setEditionFilter] = useState<string | null>(urlVersion);
  const urlVersion = searchParams.get("version");
const [editionFilter, setEditionFilter] = useState<string | null>(urlVersion ?? initialEditionFilter);
