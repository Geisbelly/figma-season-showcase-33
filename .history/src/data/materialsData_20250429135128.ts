...
export const materialsData: Material[] = [
  ...
  },
  {
    ...
    description: "Arquivo do Figma com modelo completo do WhatsApp",
    type: "modelo",
    url: "https://figma.com/file/whatsapp-templatehttps://www.figma.com/proto/rIhu55GF3hGfxozufJoR5N/WhatsApp?node-id=1-87&t=1T5QsEqeR07VdyTz-0&scaling=scale-down&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=1%3A87",
    icon: "figma",
    edition: "2024.2"
  }
];
